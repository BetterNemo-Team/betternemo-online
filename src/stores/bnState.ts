...
export const useBNStateStore = defineStore('bnState', () => {
  ...
  return { newWork, iframeRef, isPlay, isActorPage, bcmJson, defaultBCMJson, goWork, currentActor, actorList }
})
